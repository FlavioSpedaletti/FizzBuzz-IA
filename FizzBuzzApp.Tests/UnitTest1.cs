...
public class FizzBuzzServiceTests
{
    ...
    [Fact]
    public void GetFizzBuzzValue_WhenNumberIsNotMultipleOf3Or5_ReturnsNumber()
    {
    ...
    [Fact]
    public void GetFizzBuzzValue_WhenNumberIsMultipleOf3Only_ReturnsFizz()
    {
    ...
    [Fact]
    public void GetFizzBuzzValue_WhenNumberIsMultipleOf5Only_ReturnsBuzz()
    {
    ...
    [Fact]
    public void GetFizzBuzzValue_WhenNumberIsMultipleOf3And5_ReturnsFizzBuzz()
    {
